...
namespace SCADACommon.Model {
    ...
    public class DigitalInputTag : InputTag {
        ...
        public DigitalInputTag(int scanTime, List<Alarm> alarms, bool onScan, bool autoMode,
            FunctionType functionType)
            : base(scanTime, alarms, onScan, autoMode, functionType) { }

        public DigitalInputTag(string id, string description, SimulationDriver driver, string address,
            int scanTime,
